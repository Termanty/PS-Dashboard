...
function CreateNewSurvey() {
  ...
  return (
    <Paper
      sx={{
        width: 800, height: 600, backgroundColor: "#D7E5F0",
        justifyContent: "center", textAlign: "center", marginLeft: "25%", marginTop: "10%"
        }}
        >
    <div style={{
      width: "100%",
      ...
      <label className={classes.title}>Suvey Title<span style={{color:"red", fontSize: 45}}>*</span></label>
