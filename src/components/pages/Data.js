    ...
    datasets: [
      {
        ...
        borderWidth: 0,
        backgroundColor: ["#E26060", "#F3C934", "#52A569"],
        hoverOffset: 4,
        circumference: 180,
        rotation: -90,
        options: {
  ...
  return (
    <div>
      ...
      >
        ...
        >
          <Typography
            sx={{ color: "black", m: 5, width: 120, paddingRight: 2 }}
            align="center"
            variant="h4"
            component="div"
          >
